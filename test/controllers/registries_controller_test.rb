...
class RegistriesControllerTest < ActionController::TestCase
  ...
  test "should create registry" do
    assert_difference('Registry.count') do
      post :create, registry: { active: @registry.active, finished_course: @registry.finished_course, limit_date: @registry.limit_date }
    end
  ...
  test "should update registry" do
    patch :update, id: @registry, registry: { active: @registry.active, finished_course: @registry.finished_course, limit_date: @registry.limit_date }
    assert_redirected_to registry_path(assigns(:registry))
  end
